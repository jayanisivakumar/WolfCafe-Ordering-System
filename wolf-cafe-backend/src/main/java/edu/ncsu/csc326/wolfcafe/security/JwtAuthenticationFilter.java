...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        // Validate token only if it exists
        if (StringUtils.hasText(token)) {
            try {
                ...
                // Token is invalid or expired - just skip authentication
                // The request will be processed and Spring Security will handle authorization
            }
        }
